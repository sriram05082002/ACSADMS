...
{
//echo $_REQUEST['reg'];
$qry=mysql_query("SELECT * FROM stud WHERE reg='$reg' && dob='$dob'");
$num=mysql_num_rows($qry);
if($num==1)
{
$_SESSION['r']=$_REQUEST['reg'];
...
<div id="wrap">
	...
	<div id="content">
		...
		<div id="page">
			...
			<h2>WELCOME TO AUTOMATED COLLEGE STUDENTS ARREARS DETAILS MANAGEMENT SYSTEM </h2>
			...
			<table width="85%" border="0" align="right">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan="2" rowspan="2"><div align="center" class="style1">Student Login</div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td colspan="2" rowspan="6"><img src="images/STUDENT.jpeg" alt="" width="348" height="371" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td height="31"><span class="style2">Registration no</span></td>
                <td><label>
              ...
              <tr>
                <td height="44"><span class="style2">date of birth</span></td>
                <td><label>
